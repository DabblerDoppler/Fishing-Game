...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/TestLog_memoryC0_uid231_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/TestLog_memoryC0_uid232_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/TestLog_memoryC1_uid235_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/TestLog_memoryC1_uid236_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/TestLog_memoryC2_uid239_lnTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/TestLog.vo"
fi
