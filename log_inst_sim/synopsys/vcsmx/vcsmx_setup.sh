...
TOP_LEVEL_NAME="log_inst"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="F:/quartusstuff/quartus/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/log_inst_memoryC0_uid231_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/log_inst_memoryC0_uid232_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/log_inst_memoryC1_uid235_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/log_inst_memoryC1_uid236_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/log_inst_memoryC2_uid239_lnTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/log_inst.vo"
fi
